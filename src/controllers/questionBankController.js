  ...
  try {
    ...
    if (question.createdBy.toString() !== req.user._id.toString()) {
      ...
      return res
        .status(403)
        .json({
          message: "Access denied. You are not the creator of this question.",
        });
    }
    ...
    if (questionType) {
      if (
        ...
        return res
          ...
          .json({
            message:
              "Multiple choice questions must have between 3 and 5 options.",
          });
      }
    }
  ...
  try {
    ...
    if (
      ...
      return res
        .status(403)
        .json({
          message: "You are not authorized to link this question to this test",
        });
    }
    ...
    if (test.questions.includes(id)) {
      return res
        .status(400)
        .json({ message: "Question already linked to this test" });
    }
  ...
  try {
    ...
    if (
      ...
      return res
        ...
        .json({
          message:
            "You are not authorized to unlink this question from this test",
        });
    }
    ...
    if (!test.questions.includes(id)) {
      return res
        .status(400)
        .json({ message: "Question is not linked to this test" });
    }
